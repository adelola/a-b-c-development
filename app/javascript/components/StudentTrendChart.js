...
const StudentTrendChart = (props) => {
  ...
  const renderLineChart = (
    <AreaChart width={400} height={400} data={props.data} margin={{ top: 5, right: 5, bottom: 5, left: 5 }}>
      {/* <Line type="monotone" dataKey="score" stroke="#8884d8" isAnimationActive={false} dot={<CustomizedDot />}/> */}
      {/* <Line type="monotone" dataKey="score" stroke="#8884d8" isAnimationActive={false} /> */}
      <defs>
      ...
      <Area type="monotone" dataKey="score" stroke="#000" fill="url(#splitColor)" dot={{ stroke: 'black', strokeWidth: 1 }} isAnimationActive={true} animationEasing="ease-in-out" />
    </AreaChart>
  );
